...
\definecolor{darkgray}{RGB}{165,42,42}
...
% frontmatter. This will work for title, abstract and n. Though the
...
\usepackage[backend=biber,style=numeric,sorting=none,sortcites=true,maxbibnames=5,doi=false,url=true,eprint=false]{biblatex}
...
\usepackage[spanish,french]{babel}		%For languages characters and hyphenation
...
%
\AtBeginDocument{\renewcommand{\bibname}{Références bibliographiques}}
\AtBeginDocument{\renewcommand{\refname}{Références bibliographiques}}
...
% in the text.
% 
%\addtocontents{toc}{\hspace{-0.60cm}{\bf Dédicace} \nobreak \mbox{}\hfill{\bf i}\par\nobreak}
...
%\addtocontents{toc}{\hspace{-0.60cm}{\bf } \nobreak \mbox{}\hfill{\bf }\par\nobreak}
%\addtocontents{toc}{\hspace{-0.60cm}{\bf Table des matières} \nobreak \mbox{}\hfill{\bf xi}\par\nobreak}
...
\setcounter{enumiv}{0} % Réinitialise le compteur de bibliographie
\renewcommand{\theenumiv}{\arabic{enumiv}} % Définit le format de numérotation
...
\printbibliography[heading=headingArticle,type=article,title={Articles de Revue}]
\printbibliography[heading=headingInproceedings,type=inproceedings,title={Actes de Conférence}]
\printbibliography[heading=headingTechreport,type=techreport,title={Rapports Techniques}]
\printbibliography[heading=headingOnline,type=online,notkeyword={image},title={Sites Internet et Ressources en Ligne}] % Exclut les images ici
\printbibliography[heading=headingImages,keyword={image},title={Images}] % Affiche seulement les éléments avec le keyword 'image'
\printbibliography[heading=headingMisc,type=misc,notkeyword={image},title={Divers (Autres types de documents)}] % Exclut les images ici
\printbibliography[heading=subbibliography,nottype={article,inproceedings,techreport,online,misc},notkeyword={image},title={Autres}]
\clearemptydoublepage
\import{chapters/annexes/}{annexes.tex}

% Définir les headings pour chaque catégorie (titres des sous-sections)
\defbibheading{headingArticle}{\section*{Articles de Revue}}
\defbibheading{headingInproceedings}{\section*{Actes de Conférence}}
\defbibheading{headingTechreport}{\section*{Rapports Techniques}}
\defbibheading{headingOnline}{\section*{Sites Internet et Ressources en Ligne}}
\defbibheading{headingMisc}{\section*{Divers}}
\defbibheading{headingImages}{\section*{Images}} % Nouveau heading pour les images

% Imprimer chaque catégorie en utilisant 'type' ou 'keyword'
% L'ordre ici définit l'ordre dans le document.


% Si vous voulez inclure d'autres types BibTeX (comme @book, @phdthesis, etc.) que vous pourriez ajouter plus tard:
...
% Pour attraper tout ce qui n'a pas été catégorisé explicitement (utile pour le débogage ou si vous oubliez un type)
% Assurez-vous que cette dernière commande est bien à la fin de vos printbibliography


% --- FIN DE LA NOUVELLE SECTION DE BIBLIOGRAPHIE PAR CATÉGORIES ---
